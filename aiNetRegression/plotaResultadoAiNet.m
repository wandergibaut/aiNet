...
%           resultado.pop_it: matriz contendo as posiï¿½ï¿½es de cada partï¿½cula
%                             em cada uma das iteraï¿½ï¿½es (cada par de vetor
%                             colunas corresponde a uma iteraï¿½ï¿½o)
%           resultado.x_it: matriz contendo a melhor posiï¿½ï¿½o (soluï¿½ï¿½o) de
%                             cada iteraï¿½ï¿½o (cada linha corresponde a uma iteraï¿½ï¿½o)
%           resultado.x:   vetor linha de dimensï¿½o 2, corresponde a melhor
%                             soluï¿½ï¿½o encontrada pelo algoritmo
%
%   fun: um function_handle contendo a funï¿½ï¿½o a ser plotada:
%        exemplo:
%                   fun=@(a)-((a(1)-1)^2+(a(2)-1)^2);
%
%  options: estrutura contendo as opï¿½ï¿½es
%           options.limites: [lmin lmax] -> limites mï¿½nimo e mï¿½ximo do
%                            grï¿½fico
%           
