function [C, fff] = clone_mut_select_clusteringAlt(Ab,Nc,beta,fitin,xmin,xmax,ymin,ymax,f, data)
...
% sort
    ...
    [fitness,fitSort]=sort(fitness); %Get the order of B
